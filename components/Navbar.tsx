      ...
      <div className="flex items-center justify-between h-full px-6 md:px-8">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <Button
            ...
            className="bg-white hover:bg-white/90 text-[#15120D] px-4 md:px-6 py-2 md:py-3 rounded-full text-sm md:text-base font-semibold transition-colors shadow-lg"
          >
            রেজিস্ট্রেশন করুন!
          </Button>
        </div>
